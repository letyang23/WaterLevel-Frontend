...
var MonthYearPicker = function(_PureComponent) {
  inherits(MonthYearPicker2, _PureComponent);
  function MonthYearPicker2(props) {
    classCallCheck(this, MonthYearPicker2);
    var _this = possibleConstructorReturn(this, (MonthYearPicker2.__proto__ || Object.getPrototypeOf(MonthYearPicker2)).call(this, props));
  ...
  createClass(MonthYearPicker2, [{
    ...
    value: function renderMonth(month) {
      ...
      return import_react.default.createElement(
        "div",
        { className, role: "button", tabIndex: 0, onClick: function onClick() {
    ...
    value: function renderLeftArrowButton() {
      if (this.props.selectedYear === this.props.minYear) {
        return import_react.default.createElement("i", { className: "fa fa-chevron-left disabled" });
      }
      return import_react.default.createElement("i", { role: "button", tabIndex: 0, onClick: this.handleOnClickLeftArrow, className: "fa fa-chevron-left" });
    }
  }, {
    key: "renderRightArrowButton",
    value: function renderRightArrowButton() {
      if (this.props.selectedYear === this.props.maxYear) {
        return import_react.default.createElement("i", { className: "fa fa-chevron-right disabled" });
      }
      return import_react.default.createElement("i", { role: "button", tabIndex: 0, onClick: this.handleOnClickRightArrow, className: "fa fa-chevron-right" });
    }
  }, {
    key: "render",
  ...
  return MonthYearPicker2;
}(import_react.PureComponent);
MonthYearPicker.propTypes = {
  caption: import_prop_types.default.string,
  selectedYear: import_prop_types.default.number.isRequired,
  selectedMonth: import_prop_types.default.number.isRequired,
  minYear: import_prop_types.default.number.isRequired,
  maxYear: import_prop_types.default.number.isRequired,
  onChangeYear: import_prop_types.default.func.isRequired,
  onChangeMonth: import_prop_types.default.func.isRequired
};
MonthYearPicker.defaultProps = {
  caption: "Select month and year"
};
var index_es_default = MonthYearPicker;

// dep:react-month-year-picker
var react_month_year_picker_default = index_es_default;
export {
  react_month_year_picker_default as default
};
 ...
 */
//# sourceMappingURL=react-month-year-picker.js.map
