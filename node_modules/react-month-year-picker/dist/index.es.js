...
var MonthYearPicker = function (_PureComponent) {
  ...
  createClass(MonthYearPicker, [{
    ...
    value: function renderLeftArrowButton() {
      if (this.props.selectedYear === this.props.minYear) {
        return React.createElement('i', { className: 'fa fa-chevron-left disabled' });
      }
      return React.createElement('i', { role: 'button', tabIndex: 0, onClick: this.handleOnClickLeftArrow, className: 'fa fa-chevron-left' });
    }
  }, {
    key: 'renderRightArrowButton',
    value: function renderRightArrowButton() {
      if (this.props.selectedYear === this.props.maxYear) {
        return React.createElement('i', { className: 'fa fa-chevron-right disabled' });
      }
      return React.createElement('i', { role: 'button', tabIndex: 0, onClick: this.handleOnClickRightArrow, className: 'fa fa-chevron-right' });
    }
  }, {
    key: 'render',
